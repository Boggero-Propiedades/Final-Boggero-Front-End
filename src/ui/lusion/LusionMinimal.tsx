...
const shuffle = () => [
  { color: getRandomColor(), roughness: 0.1 },
  { color: getRandomColor(), roughness: 0.75 },
  { color: getRandomColor(), roughness: 0.75 },
  { color: getRandomColor(), roughness: 0.1 },
  { color: getRandomColor(), roughness: 0.75 },
  { color: getRandomColor(), roughness: 0.75 },
  ...
  { color: getRandomColor(), roughness: 0.75 },
  { color: getRandomColor(), roughness: 0.1 },
  { color: getRandomColor(), roughness: 0.1, accent: true },
  { color: getRandomColor(), roughness: 0.75, accent: true },
  { color: getRandomColor(), roughness: 0.1, accent: true }
]
...
function Scene(props: any) { 
  ...
  const positionWidth = width <= 768 ? { position: [0, 0, 25], fov: 35.5, near: 1, far: 35 } : { position: [0, 0, 25], fov: 38.5, near: 1, far: 35 }
