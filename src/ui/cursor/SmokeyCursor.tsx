...
export default function SmokeyCursor({
  ...
  useEffect(() => {
    ...
    // ------------------------------------------------------------
  }, [ simulationResolution, dyeResolution, captureResolution, densityDissipation, velocityDissipation, pressure, pressureIterations, curl, splatRadius, splatForce, enableShading, colorUpdateSpeed, backgroundColor, transparent,
  ]);

  return (
  <>
    {/* El canvas debe ser el ÚLTIMO elemento del DOM para que, 
        por defecto, se dibuje sobre lo anterior */}
    {children}

    <canvas
      ref={canvasRef}
      id="fluid"
      // Quitamos las clases de Tailwind un momento y usamos style puro para asegurar
      style={{ 
        position: 'fixed',
        top: 0,
        left: 0,
